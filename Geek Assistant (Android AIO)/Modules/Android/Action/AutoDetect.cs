    ...
    public static void Run(bool Silent = false) {
        ...
        try {
            ...
            case 3: // online
                ...
                common.S.Save();
                Home.Manufacturer_ComboBox.Text = common.S.DeviceManufacturer;
                ...
                common.S.Save();
                Home.Rooted_Checkbox.Checked = common.S.DeviceRooted;
                if (!Silent)
                    GA_Log.LogAppendText($" | Rooted: {txt.ConvertBoolYesNo(common.S.DeviceRooted)}", 1);
                Home.ProgressBar.Value = 23;
                ...
                common.S.Save();
                Home.BootloaderUnlockable_CheckBox.Checked = common.S.DeviceBootloaderUnlockSupported;
                Home.ProgressBar.Value = 27;
                if (!Silent)
                ...
                Home.AndroidVersion_ComboBox.Text = GA_adb_Functions.ConvertAPILevelToAVer(common.S.DeviceAPILevel)[1];
                if (!Silent)
                    GA_SetProgressText.Run("Converting API level to Android name...", -1);
                Home.ProgressBar.Value = 33;
                if (!Silent)
        ...
        common.S.DeviceState = Home.DeviceState_Label.Text;
