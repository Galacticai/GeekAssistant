...
internal static partial class UnlockBL {
    ...
    public static void Run() {
        ...
        try {
            ...
            common.Home.bar.Value = 17;
            Managed.Adb.Device dev = madb.GetListOfDevice()[0];
            common.Home.bar.Value = 25;
            ...
            if (!Cancelled) {
                if (common.S.DeviceState == "Connected (ADB)" | common.S.DeviceState == "Fastboot mode") {
