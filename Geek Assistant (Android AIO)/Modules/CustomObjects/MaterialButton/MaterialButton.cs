...
namespace GeekAssistant {
    public class MaterialButton : Button, IMaterialControl {
        ...
        //override public Color ForeColor { get { return _ForeColor; } set { _ForeColor = value; } }

        private bool UpperText = true;
        //public bool UpperText { get => _UpperText; set { _UpperText = value; } }
        ...
        protected override void OnPaint(PaintEventArgs pevent) {
            ...
            //Hover
            Color HoverColor = Color.FromArgb(160, ForeColor.R, ForeColor.G, ForeColor.B);//SkinManager.GetFlatButtonHoverBackgroundColor();
            using (Brush b = new SolidBrush(Color.FromArgb((int)(_hoverAnimationManager.GetProgress() * HoverColor.A), HoverColor.RemoveAlpha())))
                g.FillRectangle(b, ClientRectangle);

            //Ripple 
            Color RippleColor = Color.FromArgb(128, base.ForeColor.R, base.ForeColor.G, base.ForeColor.B);
