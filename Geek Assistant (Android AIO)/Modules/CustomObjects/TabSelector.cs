...
namespace GeekAssistant.Controls.Material {
    public class TabSelector : MaterialTabSelector, IMaterialControl {
        public class MaterialTabSelector : Control, IMaterialControl {
            ...
            private bool ThemeChanged => _ThemeChanged = (c.S.DarkTheme != _ThemeChanged);
            ...
            protected override void OnPaint(PaintEventArgs e) {
                ...
                g.FillRectangle(new SolidBrush(colors.UI.Buttons.BarBG()),//SkinManager.ColorScheme.AccentBrush,
                                x, y, width, TAB_INDICATOR_HEIGHT);
            }
