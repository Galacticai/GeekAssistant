...
internal static class icons {
    ...
    public struct x24 {
        public struct inf {
            public static Image From_inflvls(global::inf.lvls lvls)
                => lvls switch {
                    global::inf.lvls.Warn => Warn(), // 0
                        global::inf.lvls.Error => Error(), // 1 
                        global::inf.lvls.FatalError => Error(), // 10
                        global::inf.lvls.Question => Question(), // 2
                        _ => Information()  // -1
                    };
    ...
    public struct x64 {
        ...
        //public static Image SwitchTheme(bool anti = false) => theme(anti) ? prop.x64.Theme_dark_64 : prop.x64.Theme_64;
