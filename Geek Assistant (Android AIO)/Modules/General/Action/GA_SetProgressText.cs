...
internal static partial class GA_SetProgressText {
    ...
    public static void Run(string text, int ErrorLevel) {
        ...
        case -1: {
            ...
            c.Home.bar.Style = MetroFramework.MetroColorStyle.Green;
            break;
        }
        ...
        case 1: {
            ...
            c.Home.ProgressBarLabel.Text = $"({c.ErrorInfo.code}) {text}";
            System.Media.SystemSounds.Asterisk.Play();
            return;
        }
        }

        c.PleaseWait().PleaseWait_ProgressText.Text = text;
        c.Home.ProgressBarLabel.Text = text;
        if (c.S.VerboseLogging & ErrorLevel == -1)
            GA_Log.LogAppendText(c.Home.ProgressBarLabel.Text, 1);
    }
