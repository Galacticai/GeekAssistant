...
'            S.DeviceSerial = DeviceSerial
'        End If
'        If Not DevicesCount = -1 Then
'            S.adbDeviceCount = DevicesCount
'        End If
'        If DeviceManufacturer.Length > 0 Then
'            S.DeviceManufacturer = DeviceManufacturer
'        End If
'        If DeviceAPILevel > 0 Then
'            S.DeviceAPILevel = DeviceAPILevel
'        End If
'        If DeviceUnlockedBootloader.Length > 0 Then
'            S.DeviceUnlockedBootloader = DeviceUnlockedBootloader
'        End If
'        If DeviceUnlockedBootloader.Length > 0 Then
'            S.DeviceCustomRecovery = DeviceCustomRecovery
'        End If
'        If DeviceUnlockedBootloader.Length > 0 Then
'            S.DeviceCustomROM = DeviceCustomRom
'        End If
'        S.Save()
'    End Sub
...
'        ApiToVer.Clear()
'        'Dim AndroidVer As Object = My.R.esourceManager.GetResourceSet(System.Globalization.CultureInfo.CurrentCulture, False, True)
...
'            FixManufacturerString(S.DeviceManufacturer)
'            Main.Manufacturer_ComboBox.Text = ManufacturerString_Fixed
'        End If
'        'If AndroidVersion And S.DeviceAPILevel > 0 Then
'        '    Main.AndroidVersion_ComboBox.Text = 
'        'End If
'        If Count And S.adbDeviceCount > 0 Then
'            Main.DeviceCount.Value = S.adbDeviceCount
'        End If
'    End Sub
